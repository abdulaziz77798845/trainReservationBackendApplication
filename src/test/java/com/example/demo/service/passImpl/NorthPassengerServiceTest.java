...
class NorthPassengerServiceTest {

    @Qualifier("northTemplate")
    @Mock
    private MongoTemplate northPassengerMongoTemplate;
    ...
    void addPassenger() {
        ...
        when(northPassengerMongoTemplate.insert(passenger)).thenReturn(passenger);

        Passenger savedPassenger = northPassengerService.addPassenger(passenger);
    ...
    void addPassenger_exception_is_train_id_empty(){
        ...
        when(northPassengerMongoTemplate.insert(passenger)).thenThrow(new DataAccessException("...") {});

        RuntimeException exception = assertThrows(RuntimeException.class,() -> northPassengerService.addPassenger(passenger));
    ...
    void findPassengerById() {
        ...
        when(northPassengerMongoTemplate.findById("1", Passenger.class)).thenReturn(passenger);

        Optional<Passenger> foundPassenger = northPassengerService.findPassengerById(passenger.getId());
    ...
    void findPassengerById_exception_passID_is_empty(){
        when(northPassengerMongoTemplate.findById("", Passenger.class)).thenThrow(new DataAccessException("...") {});

        RuntimeException exception = assertThrows(RuntimeException.class,() -> northPassengerService.findPassengerById(""));
        assertEquals("Failed to find passenger by ID", exception.getMessage());
    }

    @Test
    void findPassengerById_exception_passID_is_null(){
        when(northPassengerMongoTemplate.findById(null, Passenger.class)).thenThrow(new DataAccessException("...") {});

        RuntimeException exception = assertThrows(RuntimeException.class,() -> northPassengerService.findPassengerById(null));
        assertEquals("Failed to find passenger by ID", exception.getMessage());
    }
    ...
    void deletePassengerByID() {
        ...
        when(northPassengerMongoTemplate.remove(query, Passenger.class)).thenReturn(null);

        northPassengerService.deletePassengerByID(passID);
        verify(northPassengerMongoTemplate, times(1)).remove(query, Passenger.class);
    }
    ...
    void delete() {
        ...
        when(northPassengerMongoTemplate.findById("6630ba4534a44e7b63c63891", Passenger.class)).thenReturn(null);


        northPassengerService.delete(passenger);
        verify(northPassengerMongoTemplate,times(1)).remove(new Query(Criteria.where("_id").is(passenger.getId())), Passenger.class);
    }
    ...
    void getAllPassengersInTheRegion() {
        ...
        when(northPassengerMongoTemplate.findAll(Passenger.class)).thenReturn(passengers);

        List<Passenger> foundPassengers = northPassengerService.getAllPassengersInTheRegion();
    ...
    void savePassenger() {
        ...
        when(northPassengerMongoTemplate.save(passenger)).thenReturn(passenger);
    ...
    public void getAllPassengersInTheRegion_exception_passID_is_null() {
        when(northPassengerMongoTemplate.findAll(Passenger.class)).thenThrow(new DataAccessException("...") {
        });

        RuntimeException exception = assertThrows(RuntimeException.class, () -> northPassengerService.getAllPassengersInTheRegion());
    ...
    public void savaPassenger_exception() {
        Passenger passenger = new Passenger();
        when(northPassengerMongoTemplate.save(passenger)).thenThrow(new DataAccessException("...") {});

        RuntimeException exception = assertThrows(RuntimeException.class,() -> northPassengerService.savePassenger(passenger));
    ...
    public void delete_exception(){
        ...
        doThrow(new DataAccessException("...") {}).when(northPassengerMongoTemplate).remove(query, Passenger.class);
