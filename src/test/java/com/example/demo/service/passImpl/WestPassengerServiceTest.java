...
class WestPassengerServiceTest {

    @Qualifier("westTemplate")
    @Mock
    private MongoTemplate westPassengerMongoTemplate;
    ...
    void addPassenger() {
        ...
        when(westPassengerMongoTemplate.insert(passenger)).thenReturn(passenger);

        Passenger savedPassenger = westPassengerService.addPassenger(passenger);
    ...
    void addPassenger_exception_is_train_id_empty(){
        ...
        when(westPassengerMongoTemplate.insert(passenger)).thenThrow(new DataAccessException("...") {});

        RuntimeException exception = assertThrows(RuntimeException.class,() -> westPassengerService.addPassenger(passenger));
    ...
    void findPassengerById() {
        ...
        when(westPassengerMongoTemplate.findById("1", Passenger.class)).thenReturn(passenger);

        Optional<Passenger> foundPassenger = westPassengerService.findPassengerById(passenger.getId());
    ...
    void findPassengerById_exception_passID_is_empty(){
        when(westPassengerMongoTemplate.findById("", Passenger.class)).thenThrow(new DataAccessException("...") {});

        RuntimeException exception = assertThrows(RuntimeException.class,() -> westPassengerService.findPassengerById(""));
        assertEquals("Failed to find passenger by ID", exception.getMessage());
    }

    @Test
    void findPassengerById_exception_passID_is_null(){
        when(westPassengerMongoTemplate.findById(null, Passenger.class)).thenThrow(new DataAccessException("...") {});

        RuntimeException exception = assertThrows(RuntimeException.class,() -> westPassengerService.findPassengerById(null));
        assertEquals("Failed to find passenger by ID", exception.getMessage());
    }
    ...
    void deletePassengerByID() {
        ...
        when(westPassengerMongoTemplate.remove(query, Passenger.class)).thenReturn(null);

        westPassengerService.deletePassengerByID(passID);
        verify(westPassengerMongoTemplate, times(1)).remove(query, Passenger.class);
    }
    ...
    void delete() {
        ...
        when(westPassengerMongoTemplate.findById("6630ba4534a44e7b63c63891", Passenger.class)).thenReturn(null);


        westPassengerService.delete(passenger);
        verify(westPassengerMongoTemplate,times(1)).remove(new Query(Criteria.where("_id").is(passenger.getId())), Passenger.class);
    }
    ...
    void getAllPassengersInTheRegion() {
        ...
        when(westPassengerMongoTemplate.findAll(Passenger.class)).thenReturn(passengers);

        List<Passenger> foundPassengers = westPassengerService.getAllPassengersInTheRegion();
    ...
    void savePassenger() {
        ...
        when(westPassengerMongoTemplate.save(passenger)).thenReturn(passenger);
    ...
    public void getAllPassengersInTheRegion_exception_passID_is_null() {
        when(westPassengerMongoTemplate.findAll(Passenger.class)).thenThrow(new DataAccessException("...") {
        });

        RuntimeException exception = assertThrows(RuntimeException.class, () -> westPassengerService.getAllPassengersInTheRegion());
    ...
    public void savaPassenger_exception() {
        Passenger passenger = new Passenger();
        when(westPassengerMongoTemplate.save(passenger)).thenThrow(new DataAccessException("...") {});

        RuntimeException exception = assertThrows(RuntimeException.class,() -> westPassengerService.savePassenger(passenger));
    ...
    public void delete_exception(){
        ...
        doThrow(new DataAccessException("...") {}).when(westPassengerMongoTemplate).remove(query, Passenger.class);
